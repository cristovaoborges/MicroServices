...
namespace Stone.Estabelecimentos.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            opt.UseSqlServer(
                Configuration.GetConnectionString("DbStone")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Stone.Estabelecimentos.API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Stone.Estabelecimentos.API v1"));
            }
